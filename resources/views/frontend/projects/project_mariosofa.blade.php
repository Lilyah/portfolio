...
<div class="container">
            ...
            <section class="projects">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right" style="color:gray"></i><samp> Intervention Image Library - PHP Image handling and manipulating library</samp></li>
                    ...
                    <li><i class="fas fa-angle-double-right" style="color:gray"></i><samp> ToastrJS - pop-up messages for Admin panel</samp></li>
                    <li><i class="fas fa-angle-double-right" style="color:gray"></i><samp> Venobox - jQuery Plugin</samp></li>
                </ul>
                <p>Тhe Аdmin panel is equipped with full CRUD functionality for all elements of every page.</p>
                ...
                <div class="d-flex flex-row flex-wrap justify-content-between mt-5">
                    ...
                    <!-- First/Left image -->
                    <div class="col-xl-6 text-center mb-5 mb-lg-0 p-2">
                        <img class="img-fluid float-xl-right float-sm-none" data-bs-toggle="modal" data-bs-target="#firstModal" src="{{ asset('frontend/assets/images/mariosofa-admin2.png') }}" alt="Mario Sofa & Bed Project Admin Panel">                    
                    </div>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <img class="img-fluid float-xl-right float-sm-none" src="{{ asset('frontend/assets/images/mariosofa-admin2.png') }}" alt="Mario Sofa & Bed Project Admin Panel">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Second/Right image -->
                    <div class="col-xl-6 text-center mb-5 mb-lg-0 p-2">
                        <img class="img-fluid float-xl-right float-sm-none" data-bs-toggle="modal" data-bs-target="#secondModal" src="{{ asset('frontend/assets/images/mariosofa-admin1.png') }}" alt="Mario Sofa & Bed Project Admin Panel">                    
                    </div>
                    ...
                    <div class="modal fade" id="secondModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <img class="img-fluid float-xl-right float-sm-none" src="{{ asset('frontend/assets/images/mariosofa-admin1.png') }}" alt="Mario Sofa & Bed Project Admin Panel">
                                </div>
                            </div>
                        </div>
                    </div>
